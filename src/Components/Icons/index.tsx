...
export function Megaphone({
  ...
  return (
    <Svg width={width} height={height} style={style} {...props} fill="#000000" viewBox="0 0 32 32">
      <G id="SVGRepo_iconCarrier">
...
export function GymIcon({
  ...
  return (
    <Svg width={width} height={height} style={style} {...props} id="Icons" viewBox="0 0 32 32" fill="#000000">
      <G id="SVGRepo_iconCarrier">
