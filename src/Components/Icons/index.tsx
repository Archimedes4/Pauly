...
export function GearIcon({ width, height, style, color }: colorIconProps) {
  return (
    <Svg
      width={width}
      height={height}
...
export function FutureIcon({ width, height, style, color }: colorIconProps) {
  return (
    <Svg
      viewBox="0 0 24 24"
      width={width}
...
export function CurrentIcon({ width, height, style, color }: colorIconProps) {
  return (
    <Svg
      viewBox="0 0 24 24"
      id="Layer_1"
...
export function PiggyBankIcon({ width, height, style, color }: colorIconProps) {
  return (
    <Svg
      viewBox="0 0 32 32"
      width={width}
...
export function MoreIcon({ width, height, style, color }: colorIconProps) {
  return (
    ...
    >
      <G id="SVGRepo_iconCarrier">
        <Path d="M10 2C5.58172 2 2 5.58172 2 10C2 14.4183 5.58172 18 10 18C14.4183 18 18 14.4183 18 10C18 5.58172 14.4183 2 10 2ZM7 10C7 10.5523 6.55228 11 6 11C5.44772 11 5 10.5523 5 10C5 9.44772 5.44772 9 6 9C6.55228 9 7 9.44772 7 10ZM11 10C11 10.5523 10.5523 11 10 11C9.44772 11 9 10.5523 9 10C9 9.44772 9.44772 9 10 9C10.5523 9 11 9.44772 11 10ZM15 10C15 10.5523 14.5523 11 14 11C13.4477 11 13 10.5523 13 10C13 9.44772 13.4477 9 14 9C14.5523 9 15 9.44772 15 10Z"/>
      </G>
    </Svg>
  )
}
...
// https://www.svgrepo.com/svg/485793/megaphone1?edit=true
export function Megaphone({ width, height, style, props }: iconProps) {
  return (
    <Svg
      width={width}
      height={height}
...
export function GymIcon({ width, height, style, props }: iconProps) {
  return (
    <Svg
      width={width}
      height={height}
  ...
  return (
    ...
    >
      <G id="SVGRepo_iconCarrier">
        <Path
          fill="#000000"
          d="M477.215,173.08v234.041H457.83V65.941l-27.122,23.554c-3.412,2.958-8.477,2.958-11.879,0l-33.196-28.832 c-5.676-4.927-14.124-4.927-19.801,0l-33.168,28.832c-3.401,2.968-8.477,2.968-11.878,0L287.666,60.69 c-5.676-4.936-14.125-4.927-19.801,0l-33.121,28.814c-3.402,2.968-8.477,2.968-11.879,0L189.734,60.69 c-5.676-4.927-14.116-4.936-19.792,0l-33.13,28.814c-3.411,2.968-8.486,2.968-11.879,0L91.812,60.69 c-5.685-4.927-14.135-4.927-19.819,0L38.89,89.495c-3.412,2.977-8.486,2.977-11.898,0L0,65.987v344.656 c0.01,12.312,4.936,23.304,12.997,31.383c8.088,8.06,19.08,12.997,31.393,13.006h408.126c16.472-0.009,31.245-6.637,42.051-17.425 c10.797-10.816,17.415-25.587,17.433-42.061V139.505L477.215,173.08z M69.21,152.614h128.789v120.579H69.21V152.614z M383.304,376.487H69.21V359.2h314.094V376.487z M383.304,324.839H69.21v-17.295h314.094V324.839z M383.304,273.193H249.885 v-17.286h133.419V273.193z M383.304,221.556H249.885V204.26h133.419V221.556z M383.304,169.919H249.885v-17.305h133.419V169.919z"
        />
      </G>
    </Svg>
  );
