...
export async function getValueFromRedux<ReturnType>(dispatch: AsyncThunkAction<any, any, any>, cached: (store: RootState) => ReturnType | undefined, stateUpdating: (store: RootState) => boolean, store: StoreType): Promise<{ result: loadingStateEnum.failed; } | { result: loadingStateEnum.success; data: ReturnType}> {
