...
function UserImage({ id }: { id: string }) {
  ...
  const [state, setState] = useState<loadingStateEnum>(
    ...
    return (
      <View style={{ paddingTop: 5, paddingBottom: 5, marginTop: 'auto' }}>
        <ProgressView
          ...
          style={{
            margin: 'auto',
            width: getLength(width, height),
            height: getLength(width, height),
          }}
        />
      </View>
    );
      ...
      <View style={{ paddingTop: 5, paddingBottom: 5 }}>
        <Image
          ...
          style={{
            ...
            height: getLength(width, height),
            margin: 'auto',
            borderRadius: getLength(width, height) / 2,
          }}
        />
      </View>
    );
      ...
      <View style={{ width, height }}>
        ...
        <FlatList
          ...
          renderItem={user => (
            ...
            >
              <Text style={{ marginRight: 3, fontFamily: 'Roboto' }}>
                ...
                >
                  ...
                  <View
                    style={{
                      ...
                      marginTop: topThree.length >= 3 ? 0 : 'auto',
                    }}
                  >
                    {topThree.length >= 3 ? (
                      <Text
                ...
                <View style={{ width: width * 0.2, height: height * 0.3 }}>
                  ...
                  <View
                    style={{
                      ...
                      marginLeft: 'auto',
                      marginTop: topThree.length >= 1 ? 0 : 'auto',
                    }}
                  >
                    {topThree.length >= 1 ? (
                      <Text
                ...
                >
                  ...
                  <View
                    style={{
                      ...
                      marginLeft: 'auto',
                      marginTop: topThree.length >= 2 ? 0 : 'auto',
                    }}
                  >
                    {topThree.length >= 2 ? (
                      <Text
