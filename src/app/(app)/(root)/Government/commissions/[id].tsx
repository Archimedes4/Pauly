...
import CommissionsPostComponent from '@src/components/government/comissions/CommissionsPostComponent';
...
function CommissionSubmissionButton({submission, setSelectedSubmission}:{submission: ListRenderItemInfo<submissionType>, setSelectedSubmission: (item: submissionType) => void}) {
  ...
  return (
    <Pressable
      ...
      onPress={() => setSelectedSubmission(submission.item)}
