...
export default function AnimatedColor({progress, unCheckedBorderColor, checkedBorderColor, unCheckedBackgroundColor,checkedBackgroundColor}:{progress: SharedValue<number>, unCheckedBorderColor: string, checkedBorderColor: string, unCheckedBackgroundColor: string, checkedBackgroundColor: string}) {
