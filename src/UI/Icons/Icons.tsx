...
export function SearchIcon({width, height, style}:iconProps) {
  return (
    <Svg width={width} height={height} style={style} fill="#000000" id="Capa_1" viewBox="0 0 488.4 488.4">
      <G id="SVGRepo_bgCarrier" strokeWidth="0"/>
      <G id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"/>
      <G id="SVGRepo_iconCarrier"> 
        <G>
  ...
  return (
    <Svg width={width} height={height} style={style} viewBox="0 0 32 32" fill="#000000">
      ...
      <G id="SVGRepo_iconCarrier">
        ...
        <Path d="M16.434,8.2H8.512V24.45h7.922a1.2,1.2,0,0,0,1.194-1.191V9.391A1.2,1.2,0,0,0,16.434,8.2Z" opacity={0.10000000149011612}  />{/*isolation:isolate*/}
  ...
  return (
    <Svg width={width} height={height} style={style} viewBox="0 0 32 32" fill="#000000">
      ...
      <G id="SVGRepo_iconCarrier">
        ...
        <Path d="M17.628,9.389V23.26a1.2,1.2,0,0,1-.742,1.1,1.16,1.16,0,0,1-.45.091H7.027c-.182-.208-.358-.429-.521-.65a12.735,12.735,0,0,1-2.553-7.657v-.286A12.705,12.705,0,0,1,6.05,8.85c.143-.221.293-.442.456-.65h9.93A1.2,1.2,0,0,1,17.628,9.389Z" opacity={0.10000000149011612}/>{/*isolation:isolate*/}
        <Path d="M16.977,10.04V23.911a1.15,1.15,0,0,1-.091.448,1.2,1.2,0,0,1-1.1.741H7.62q-.309-.314-.593-.65c-.182-.208-.358-.429-.521-.65a12.735,12.735,0,0,1-2.553-7.657v-.286A12.705,12.705,0,0,1,6.05,8.85h9.735A1.2,1.2,0,0,1,16.977,10.04Z" opacity={0.20000000298023224}/>{/*isolation:isolate*/}
        <Path d="M16.977,10.04V22.611A1.2,1.2,0,0,1,15.785,23.8H6.506a12.735,12.735,0,0,1-2.553-7.657v-.286A12.705,12.705,0,0,1,6.05,8.85h9.735A1.2,1.2,0,0,1,16.977,10.04Z" opacity={0.20000000298023224}/>{/*isolation:isolate*/}
        <Path d="M16.326,10.04V22.611A1.2,1.2,0,0,1,15.134,23.8H6.506a12.735,12.735,0,0,1-2.553-7.657v-.286A12.705,12.705,0,0,1,6.05,8.85h9.084A1.2,1.2,0,0,1,16.326,10.04Z" opacity={0.20000000298023224}/>{/*isolation:isolate*/}
        <Path d="M3.194,8.85H15.132a1.193,1.193,0,0,1,1.194,1.191V21.959a1.193,1.193,0,0,1-1.194,1.191H3.194A1.192,1.192,0,0,1,2,21.959V10.041A1.192,1.192,0,0,1,3.194,8.85Z" fill={"#c5401e"}/>
  ...
  return (
    <Svg width={width} height={height} style={style} viewBox="0 0 24 24" fill="none">
      ...
      <G id="SVGRepo_iconCarrier">
        ...
        <Path d="M14.5355 8.46447C15.4684 9.39732 15.9948 10.6611 16 11.9803C16.0052 13.2996 15.4888 14.5674 14.5633 15.5076" stroke="#222222" strokeWidth="2" strokeLinecap="round"/>
        <Path d="M18.6569 6.34314C20.1494 7.83572 20.9916 9.85769 20.9999 11.9685C21.0083 14.0793 20.182 16.1078 18.7012 17.6121" stroke="#222222" strokeWidth="2" strokeLinecap="round"/>
      </G>
    </Svg>
  )
}
  ...
  return (
    <Svg width={width} height={height} style={style} viewBox="0 0 32 32" fill="none">
      ...
      <G id="SVGRepo_iconCarrier">
        ...
        <Path d="M13 21V11H10.8893V16.8286L6.9631 11H5V21H7.08118V14.9571L11.155 21H13Z" fill={Colors.white}/>
        <Defs>
...
export function TrashIcon({width, height, style, props, color}:TrashIconProps) {
  return (
    <Svg width={width} height={height} style={style} viewBox="0 0 24 24" fill="none" {... props}>
      <G id="SVGRepo_iconCarrier">
        <Path d="M4 6H20L18.4199 20.2209C18.3074 21.2337 17.4512 22 16.4321 22H7.56786C6.54876 22 5.69264 21.2337 5.5801 20.2209L4 6Z" stroke={color ? color:"#000000"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <Path d="M7.34491 3.14716C7.67506 2.44685 8.37973 2 9.15396 2H14.846C15.6203 2 16.3249 2.44685 16.6551 3.14716L18 6H6L7.34491 3.14716Z" stroke={color ? color:"#000000"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <Path d="M2 6H22" stroke={color ? color:"#000000"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <Path d="M10 11V16" stroke={color ? color:"#000000"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <Path d="M14 11V16" stroke={color ? color:"#000000"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </G>
    </Svg>
  )
}
