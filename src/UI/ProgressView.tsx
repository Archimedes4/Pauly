...
import { interpolateColor, useAnimatedProps, useSharedValue, withDelay, withRepeat, withTiming } from 'react-native-reanimated';
...
function ChipView({d, index}:{d:string, index: number}) {
  ...
  useEffect(() => {
    progress.value = withDelay(((index + 1)/8) * 1000, withRepeat(withTiming(1, { duration: 500 }), 0, true))
  }, []);
