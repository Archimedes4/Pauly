...
export default function GovernmentClassesCreate() {
    ...
    async function getUsers() {
        ...
        const result = await callMsGraph((teacherNameSearch === "") ? "https://graph.microsoft.com/v1.0/users/":"https://graph.microsoft.com/v1.0/users/?$filter=startswith(displayName,'" + encodeURI(teacherNameSearch) + "')")
        if (result.ok){
