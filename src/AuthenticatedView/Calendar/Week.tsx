        ...
        <View>
          <View style={{flexDirection: "row", height: width * 0.142857142857143, width: width}}>
            ...
            {daysOfWeek.map((day) => (
              ...
              }} key={day.getDay() + "_" + create_UUID()} style={{width: width * 0.08888888888888889, height: width * 0.08888888888888889, margin: width * 0.01111111111111111, borderRadius: 50, backgroundColor: Colors.darkGray, alignContent: "center", alignItems: "center", justifyContent: "center", borderColor: (day.getDate() === new Date(selectedDateRedux).getDate()) ? "black":Colors.maroon, borderWidth: (new Date().getDate() === day.getDate() || day.getDate() === new Date(selectedDateRedux).getDate()) ? 5:0}}>
