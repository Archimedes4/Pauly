  ...
  return (
    <View style={{backgroundColor: "#793033", alignContent: "center", alignItems: "center", justifyContent: "center", height: height, width: width, overflow: "hidden"}}>
      <View style={{height: (100 * width/230), width: (100 * width/360) * 2.2, flexDirection: "row"}} id='text outlinewr'>
        ...
        <Text style={{position: "absolute", left: (100 * width/600), top: (30 * width/600),  fontFamily: "Gochi Hand", fontSize: (80 * width/360), textShadowColor: 'rgba(0, 0, 0, 1)', textShadowOffset: {width: 1, height: 1}, textShadowRadius: 10, color: "white"}}>auly</Text>
      </View>
      <Pressable onPress={async () => {onGetAuthToken()}} onHoverIn={() => {setButtonColor("blue")}} onHoverOut={() => {setButtonColor("white")}} style={{height: height * 0.1, width: width * 0.5, borderRadius: 50, backgroundColor: "white", alignContent: "center", alignItems: "center", justifyContent: "center", shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.8, shadowRadius: 10}}>
